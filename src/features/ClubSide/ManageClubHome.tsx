...
const clubLogo = localStorage.getItem("logoUrl") || "your-default-logo.png";
  ...
  style={{
    backgroundImage: localStorage.getItem("bannerUrl") ? `url(${localStorage.getItem("bannerUrl")})` : "none",
...
>
  ...
  <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-2xl bg-black/40 border border-white/10 flex items-center justify-center overflow-hidden shrink-0">
    {localStorage.getItem("logoUrl") ? (
      ...
      <span className="text-[9px] font-bold text-gray-500 tracking-wider text-center px-2">
        No Logo
      </span>
    )}
  </div>
  <div className="flex flex-col justify-center">
    <h1 className="text-3xl sm:text-4xl font-black text-white uppercase tracking-tight break-words">
      {localStorage.getItem("clubName") || "Club Name"}
    </h1>
  ...
  {["Members", "Membership Plans", "Discount", "News", "Leaderboard"].map((tab) => {
              ...
              <div className="flex gap-3 pt-4">
                ...
                >
                  <span className="relative z-10">
                    {editingPlanId ? "Save Changes" : "Create Membership Plan"}
                  </span>
                </button>
              </div>
            </form>
          ...
          membershipPlans.map((plan) => (
            ...
            >
              ...
              <div className="absolute top-6 right-6 z-40">
                <button
                  onClick={() =>
                    setOpenCardMenuId(openCardMenuId === plan.id ? null : plan.id)
                  }
