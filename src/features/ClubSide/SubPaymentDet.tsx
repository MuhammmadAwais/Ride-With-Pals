...
const SubPaymentDet = () => {
  ...
  const inputClasses = (name: string) => `
    w-full h-14 bg-main-bg border border-border rounded-2xl pl-12 pr-4 outline-none text-md transition-all duration-300 text-text-main
    ${focused === name ? 'border-[#EB712B] shadow-[0_0_15px_rgba(235,113,43,0.1)]' : 'hover:border-border'}
  `;

  return (
    <div className="min-h-screen text-text-main bg-main-bg p-6 md:p-10 flex flex-col items-center">
