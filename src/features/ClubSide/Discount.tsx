  ...
  <div className="group relative bg-[#161616] border border-white/[0.05] rounded-3xl p-5 md:p-6 overflow-hidden transition-all duration-500 hover:border-[#EB712B]/30">
    ...
    <div className="relative z-10">
      ...
      <div className="flex justify-between items-start mb-6 gap-2">
        ...
        <div className="bg-[#EB712B]/10 px-2 py-1 md:px-3 rounded-full border border-[#EB712B]/20 shrink-0">
          <span className="text-[#EB712B] text-[9px] md:text-[10px] font-black uppercase">20% OFF</span>
        </div>
      </div>
...
const Discount = () => {
  ...
  return (
    <div className="px-4 py-8 md:p-8 min-h-screen text-white ">
      {/* Header Section */}
<div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-12">
  <div className="w-full lg:w-auto">
    <h1 className="text-2xl md:text-3xl font-black mb-2">Discounts & Promotions</h1>
  ...
  <div className="flex flex-wrap items-center gap-4 w-full lg:w-auto">
    ...
    <div className="flex bg-[#0a0a0a] p-1 rounded-full border border-white/[0.05] w-full lg:w-auto overflow-hidden">
      <button
        ...
        className={`flex-1 lg:px-8 py-2.5 rounded-full text-[10px] md:text-xs font-bold transition-all duration-300 ${
          activeTab === 'active' 
