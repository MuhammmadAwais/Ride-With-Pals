...
const MetricCard = ({ icon, value, label, title }: MetricCardProps) => (
  <div className="bg-white/5 p-4 rounded-2xl flex flex-col items-center justify-center hover:-translate-y-1 hover:bg-[#EB712B]/10 hover:border hover:border-[#EB712B] transition-all cursor-default">
    ...
    <p className="text-2xl font-black">{value} <span className="text-sm font-normal text-gray-400">{label}</span></p>
...
const Activities = () => {
  ...
  return (
    <div className="w-full text-white p-6 bg-[#111111] min-h-screen">
      {/* Header */}
      <div className="flex justify-between items-center mb-8">
        ...
        <div className="bg-[#161616] p-1 rounded-2xl flex border border-white/5">
          <button className="bg-[#EB712B] px-6 py-2 rounded-xl text-sm font-bold shadow-lg">Active Rides</button>
          <button className="px-6 py-2 text-sm text-gray-400 hover:text-white transition-colors">Completed</button>
        </div>
      </div>
        ...
        <div className="lg:col-span-2 bg-[#161616] rounded-3xl p-6 border border-white/5 hover:border-white/10 transition-colors">
          <div className="relative h-72 rounded-2xl overflow-hidden mb-6">
            ...
            <div className="absolute bottom-6 left-6">
              <h2 className="text-4xl font-bold mb-1">Mountain Ride</h2>
